...
# Producer Agent : Fossil
ag1 = ProsumerAgent(1,[1,0,0,0],False,mdl,0,0)
# Producer Agent : nuclear and solar
ag2 = ProsumerAgent(2,[0,0,1,1],False,mdl,1,1)

# Consumer Agent
ag3 = ProsumerAgent(3,[0,0,0,0],True,mdl,2,2,jobs=jobs,weights=[0,0,1])
